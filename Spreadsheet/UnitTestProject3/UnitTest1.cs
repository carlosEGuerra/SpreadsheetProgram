...
namespace SS
{
    ...
    public class UnitTest1
    {
        ...
        public void Test16()
        {
            Formula circular = new Formula("A1+A1");
            Formula A1 = new Formula("A2+A3");
            Formula A3 = new Formula("A4+A5");
            Formula A5 = new Formula("A6+A7");
            Spreadsheet s = new Spreadsheet();
            s.SetCellContents("A1", A1);
            s.SetCellContents("A3", A3);
            s.SetCellContents("A5", A5);
            s.SetCellContents("A7", circular);
        }
        ...
        public void Test27()
        {
            ...
            IEnumerator<string> str = s.SetCellContents("A4", new Formula("A2+A5")).GetEnumerator();
            while (str.MoveNext())
            {
                fullSet.Add(str.Current);
            }
