//Includes tests written by Ellen Brigance, February 2017
//Includes tests written by Joe Zachary, modified/reused by Ellen Brigance.
using System;
...
{
    /// <summary>
    /// Tests the PS4 changes to the DependencyGraph Class.
    /// </summary>
    [TestClass]
    public class UnitTest1
    {
        ...
        /// <summary>
        /// Try to add a dependency with a null dependee.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestHasDependentsNull()
        {
        ...
        /// <summary>
        /// Try to add a dependency with a null dependent.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to remove a dependency with a null dependee.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to remove a dependency with a null dependent.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TTestRemoveDependency2()
        {
            DependencyGraph dg = new DependencyGraph();
            dg.RemoveDependency(null, "t");
        }

        /// <summary>
        /// See if a null has dependees.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to remove the dependency where the dependee is null.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to remove the dependency were a dependent is null.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to replace the dependees of a null string.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        /// <summary>
        /// Try to replace dependees with a null list.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestReplaceDependees2()
        {
            ...
            dg.ReplaceDependees("t", null);
        }


        /// <summary>
        /// Try to replace dependees with real list that contains a null.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestReplaceDependent3()
        {
            HashSet<string> h = new HashSet<string>();
            h.Add("A");
            h.Add("B");
            ...
            DependencyGraph dg = new DependencyGraph();
            dg.AddDependency("s", "t");
            dg.ReplaceDependents("s", h);
        }


        /// <summary>
        /// See if a null has dependents.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestGetDependentsNull()
        {
            DependencyGraph dg = new DependencyGraph();
        ...
        //********* TESTS TO MAKE SURE THE ADDED DEPENDENCYGRAPH CONSTRUCTOR WORKS *********
        ...
        {
            DependencyGraph dg = new DependencyGraph();
            DependencyGraph t = new DependencyGraph(dg);
        ...
        public void StressTest1()
        {
            ...
            //ADDED FOR PS4
            DependencyGraph dg = new DependencyGraph(t);

            // Make sure everything is right
            for (int i = 0; i < SIZE; i++)
            {
                Assert.IsTrue(dents[i].SetEquals(new HashSet<string>(dg.GetDependents(letters[i]))));
                Assert.IsTrue(dees[i].SetEquals(new HashSet<string>(dg.GetDependees(letters[i]))));
            }
        }
